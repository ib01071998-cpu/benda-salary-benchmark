...
השתמש בנתונים הריאליים ממקורות בישראל.

הצג את כלל רכיבי השכר:
...
- ממוצע שוק (₪)
- מנגנון תגמול מפורט **בהתאם לנורמות השוק בישראל בפועל** (למשל: עמלות 5% מהמכירות נטו עד תקרה של 8,000 ₪)
- עלות מעסיק ממוצעת (₪)
- אחוז מעלות השכר הכוללת (%)

⚠️ ברכיב "רכב חברה":
- הצג את **שווי השוק של הרכב** המתאים לתפקיד (₪)
- הצג שלושה דגמים תואמים לשווי זה
- בעמודת "עלות מעסיק ממוצעת" הצג את **זקיפת השווי לעובד** (הסכום המחויב במס בישראל, לדוג׳: 3,000 ₪ לחודש עבור רכב קבוצה 4).

בסוף הדוח הוסף סיכום מעוצב וברור הכולל:
