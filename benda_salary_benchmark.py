...
הפלט חייב להיות טבלה בלבד בעברית, ללא טקסט נוסף.
...
- שלוש רמות תגמול באותה שורה (רמה בסיסית, בינונית, גבוהה)
- ממוצע שוק (₪)
...
- ציין 3 דגמים תואמים (לדוגמה: סקודה סופרב, טויוטה קאמרי, מאזדה 6)

בסוף הדוח הוסף סיכום מקצועי מעוצב:
...
if run:
    if not job.strip():
        ...
        <div class="summary-box">
          ...
          <div class="summary-line">🏢 <span class="summary-value">עלות מעסיק כוללת:</span> שכר × 1.35 + עלויות נלוות (רכב, ביטוחים, סיבוס).</div>
